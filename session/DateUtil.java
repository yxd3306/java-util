...
public class DateUtil {
    ...
    public static final String SESSION_CODE = "yyyyMMddHHmmssms";
    ...
    /**
       *  生成订单编号，sessionId头部标志等编号类的属性使用该方法
     * 
     * @param dateTime Date
     * @return
     * @throws ParseException
     */
    public static String dateTimeToDateStringIfTimeSymbol(Date dateTime) throws ParseException {
        String dateTimeString = DateUtil.dateFormat(dateTime, DateUtil.SESSION_CODE);
        if (dateTimeString.endsWith("00:00:00")) {
            return dateTimeString.substring(0, 10);
        } else {
            return dateTimeString;
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        // System.out.println(dateBetween(dateParse("2017-01-30", null), dateParse("2017-02-01",
        // null)));
